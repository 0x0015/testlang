...
bool minLang::backends::interpreter::interpreter::loadExternalFunctions(const std::list<ast::function>& funcs, std::span<const std::string> linkLibs){
...
std::vector<uint8_t> minLang::backends::interpreter::interpreter::handleExternalCall(const ast::call& call){
