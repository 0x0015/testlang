...
namespace cCodeGen{
	...
	std::unordered_multimap<std::string, std::reference_wrapper<const ast::function>> findUsedFunctions(std::reference_wrapper<const ast::function> entrypoint);
	...
	std::string genUsedFunctionForwarddefs(const std::unordered_multimap<std::string, std::reference_wrapper<const ast::function>>& funcs, const std::unordered_map<ast::type, cTypeInfo, typeHasher>& types);
	std::string genUsedFunctionDefs(const std::unordered_multimap<std::string, std::reference_wrapper<const ast::function>>& funcs, const std::unordered_map<ast::type, cTypeInfo, typeHasher>& types);
